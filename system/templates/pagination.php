<span class="pagination">
	...
	<?php if ($previous_page): ?>
		<a href="<?php echo str_replace('{page}', $previous_page, $url) ?>">&laquo;&nbsp;<?php echo Dict::word('previous'); ?></a>
	<?php else: ?>
		&laquo;&nbsp;<?php echo Dict::word('previous') ?>
	<?php endif ?>
	...
	<?php if ($next_page): ?>
		<a href="<?php echo str_replace('{page}', $next_page, $url) ?>"><?php echo Dict::word('next'); ?>&nbsp;&raquo;</a>
	<?php else: ?>
		<?php echo Dict::word('next'); ?>&nbsp;&raquo;
	<?php endif ?>
